...
public class WisataAdapter extends RecyclerView.Adapter<com.satriaamrudito.wisatapurwakarta.adapter.WisataAdapter.ViewHolder> {

    private List<ModelWisata> items;
    private com.satriaamrudito.wisatapurwakarta.adapter.WisataAdapter.onSelectData onSelectData;
    ...
    public WisataAdapter(Context context, List<ModelWisata> items, com.satriaamrudito.wisatapurwakarta.adapter.WisataAdapter.onSelectData xSelectData) {
