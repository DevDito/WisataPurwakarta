...
public class HotelAdapter extends RecyclerView.Adapter<com.satriaamrudito.wisatapurwakarta.adapter.HotelAdapter.ViewHolder> {

    private List<ModelHotel> items;
    private com.satriaamrudito.wisatapurwakarta.adapter.HotelAdapter.onSelectData onSelectData;
    ...
    public HotelAdapter(Context context, List<ModelHotel> items, com.satriaamrudito.wisatapurwakarta.adapter.HotelAdapter.onSelectData xSelectData) {
