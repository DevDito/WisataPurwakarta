...
public class MainAdapter extends RecyclerView.Adapter<com.satriaamrudito.wisatapurwakarta.adapter.MainAdapter.ViewHolder> {

    private List<ModelMain> items;
    private com.satriaamrudito.wisatapurwakarta.adapter.MainAdapter.onSelectData onSelectData;

    public interface onSelectData {
        void onSelected(ModelMain mdlMain);
    }

    public MainAdapter(List<ModelMain> items, com.satriaamrudito.wisatapurwakarta.adapter.MainAdapter.onSelectData xSelectData) {
        this.items = items;
