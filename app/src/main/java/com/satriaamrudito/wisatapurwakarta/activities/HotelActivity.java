...
import com.satriaamrudito.wisatapurwakarta.adapter.HotelAdapter;
import com.satriaamrudito.wisatapurwakarta.api.Api;
import com.satriaamrudito.wisatapurwakarta.model.ModelHotel;
...
public class HotelActivity extends AppCompatActivity implements HotelAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(com.satriaamrudito.wisatapurwakarta.activities.HotelActivity.this,
    ...
    private void showHotel() {
        hotelAdapter = new HotelAdapter(com.satriaamrudito.wisatapurwakarta.activities.HotelActivity.this,modelHotel,this);
        rvHotel.setAdapter(hotelAdapter);
    }

    @Override
    public void onSelected(ModelHotel modelHotel) {
        Intent intent = new Intent(com.satriaamrudito.wisatapurwakarta.activities.HotelActivity.this, com.satriaamrudito.wisatapurwakarta.activities.DetailHotelActivity.class);
