...
import com.satriaamrudito.wisatapurwakarta.adapter.WisataAdapter;
import com.satriaamrudito.wisatapurwakarta.api.Api;
import com.satriaamrudito.wisatapurwakarta.decoration.LayoutMarginDecoration;
import com.satriaamrudito.wisatapurwakarta.model.ModelWisata;
...
public class WisataActivity extends AppCompatActivity implements WisataAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(com.satriaamrudito.wisatapurwakarta.activities.WisataActivity.this,
    ...
    private void showWisata() {
        kulinerAdapter = new WisataAdapter(com.satriaamrudito.wisatapurwakarta.activities.WisataActivity.this, modelKuliner, this);
        rvWisata.setAdapter(kulinerAdapter);
    }

    @Override
    public void onSelected(ModelWisata modelWisata) {
        Intent intent = new Intent(com.satriaamrudito.wisatapurwakarta.activities.WisataActivity.this, DetailWisataActivity.class);
